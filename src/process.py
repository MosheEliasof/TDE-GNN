...
def full_load_citation(dataset_str, slurm=False):
...
def full_load_data(dataset_name, splits_file_path=None, slurm=False):
    if dataset_name in {'cora', 'citeseer', 'pubmed'}:
        adj, features, labels, _, _, _ = full_load_citation(dataset_name, slurm=slurm)
